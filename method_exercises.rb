...
def common_sports(current_sports,favorite_sports)
    ...
    current_sports=["football","basketball","surfear"]
    favorite_sports=["football","basketball","tennis"]
    
    resultado = common_sports(current_sports,favorite_sports)
...
def alphabetical_list(games)
  ...
  games=["Pokemon","Mortal Kombat","CsGo"]
  resultado = alphabetical_list(games)
  puts resultado
...
def lucky_number(number)
  ...
  results = number
   puts "Today lucky number is #{number}"
...
def twenty_first_century(year)
  ...
  puts twenty_first_century(1900)
